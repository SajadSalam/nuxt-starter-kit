...
import axiosIns from '~/common/services/app-client/axios';
...
dark:border-[#E0E0E024] dark:hover:border-[#E0E0E044] dark:focus:border-[#E0E0E044] bg-[#0E1224] group cursor-pointer rounded-lg border-[2px] border-dashed border-muted-300 p-3 transition-colors duration-300 hover:border-muted-400dark:border-[#E0E0E024] dark:hover:border-[#E0E0E044] dark:focus:border-[#E0E0E044] bg-[#F9FAFB] group cursor-pointer rounded-lg border-[2px] border-dashed border-muted-300 p-3 transition-colors duration-300 hover:border-muted-400w-[100%] flex items-end justify-center gap-2w-[100%]w-[100%]